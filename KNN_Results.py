...
# Fitting K-Nearest Neighbors with the best number of neighbors to the Training Set
...
for neighbors in range(1, 21):
    ...
    print("Accuracy score for {} neighbors is: {}%".format(neighbors, round(score*100, 2)))
    if score > best_accuracy:
        best_accuracy = score
        best_neighbors = neighbors

print("\nThe Best Accuracy is {} with {} neighbors".format(round(best_accuracy*100, 2), best_neighbors))
